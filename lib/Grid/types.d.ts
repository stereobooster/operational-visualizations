...
import { Cell, DimensionWithPrimitiveAndMetadata, DimensionWithValueAndMetadata, Predicate, RowOrColumn, SliceOptions } from "../data_handling/multidimensional_dataset";
...
export declare type Axes = Partial<Record<AxisPosition, SingleAxis[]>>;
/** Constant value, or record returning values per key */
export declare type ConstantOrRecord<T> = T | Record<string, T>;
...
export declare type DimensionTitleConfig = DimensionHeaderConfig & {
    /** Hide dimension titles - constant, to hide/show all, or per dimension */
    hide: boolean | Record<string, boolean>;
};
export declare type DimensionLabelConfig = DimensionHeaderConfig;
export declare type RowHeaderOrientation = "horizontal" | "vertical";
...
export declare type ConstantOrSliceArray<T> = T | Array<{
...
export declare type ConstantOrPredicateArray<T> = T | Array<{
...
export declare type DimensionTitleAccessors = DimensionHeaderAccessors<DimensionWithPrimitiveAndMetadata> & {
    hide: (dim: DimensionWithPrimitiveAndMetadata) => boolean;
};
export declare type DimensionLabelAccessors = DimensionHeaderAccessors<DimensionWithValueAndMetadata>;
